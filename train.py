...
from MoCETSE.model import EffectorTransformer, ESM1bModel
from MoCETSE.dataset import TXSESequenceDataSet
from MoCETSE.utils import label2index, viz_conf_matrix
from MoCETSE.trainer import train, test, set_seed, EarlyStopping
...
def main(args):
    ...
    if args.model == "effectortransformer":
        ...
        model = ESM1bModel(1280, 33, unfreeze_last=True, hid_dim=args.hid_dim, dropout_rate=args.dropout_rate,
                           num_classes=6)
    else:
